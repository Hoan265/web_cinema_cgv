...
require_once "mvc/Core/database_account.php";
...
<body>
    <div class="confirmOtpBox">
        ...
        if(isset($_POST['otp'])) {
            ...
            if($otp == $sent_otp){
                // echo '<p class="successs">Xác nhận thành công! Đang chuyển hướng đến trang đăng nhập...</p>';
               header("Location: mvc/Views/client/createnewpassword.php");
                exit; 
            } else {
        ...
        ?>
        <form action="otp_resetpass.php" method="post">
            <div class="inputBox">
