<?php
class list_movie extends Controller {
     public $FilmModel;
     ...
     function default(){
         $this->view("main_layout", [
            ...
            "TheLoai" => $this->FilmModel->getAllTheLoai(),
            "NoiSX" => $this->FilmModel->getAllNoiSX(),
            "NamSX" => $this->FilmModel->getAllNamSX(),
            "DoTuoi" => $this->FilmModel->getAllDoTuoi(),
            "PageRole" => "client",
         ]);
     }
